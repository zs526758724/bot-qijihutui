...
@Slf4j
public class BExecBot extends TelegramLongPollingBot {
    private final String botUserName;
    private final String token;
    private final BDealBot bDealBot;

    private final Executor taskExecutor;

    private final Executor taskExecutorsigle;

    public BExecBot(DefaultBotOptions options, String botUserName, String token, @Qualifier("taskExecutor") Executor taskExecutor, @Qualifier("taskExecutorsigle") Executor taskExecutorsigle, BDealBot bDealBot) {
        super(options);
